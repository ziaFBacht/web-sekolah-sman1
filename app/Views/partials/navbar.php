    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
            ...
            <div class="hidden md:flex space-x-8 items-center">
                <a href="#" class="text-gray-900 hover:text-primary font-medium transition">Beranda</a>
                <a href="#" class="text-gray-700 hover:text-primary font-medium transition">Profil</a>
                <a href="#" class="text-gray-700 hover:text-primary font-medium transition">Akademik</a>
                <a href="#" class="text-gray-700 hover:text-primary font-medium transition">Berita</a>
                <!-- Tombol CTA -->
